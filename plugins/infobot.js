...
var as = `Tanggal : ${week}, ${date}\nWaktu : ${a} (WIB)`
 //conn.sendTBL(m.chat, infonyacok, as, fla + `${command}`, `Source Code Bot ✨`, `https://nekopoi.care`, null, null, `Menu`, `${usedPrefix}menu`, null, null, null, null, m, 
     conn.sendBL(m.chat, infonyacok, as, fla + `${command}`, [[`SC Bot`, `${usedPrefix}sc`], [`Menu`, `${usedPrefix}menu`]], m,        
           {mentions: ['6283811034750@s.whatsapp.net']})
