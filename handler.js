...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.docux = img
        global.nd = pickRandom(['Hai', 'fardev', 'realbot', 'bot wea', 'onichan', 'kimochi', 'yamete', 'baka', 'yamero', 'fahri', 'udah', 'nyari apa', 'oh gitu', 'yaudah', 'gamau', 'yaudah', 'Udah?', 'apa lagi', 'oke'])
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            this.sendBD(id, text, wm, pp, [[`Menu`, `.menu`], [action === 'add' ? 'Welcome🍟' : 'Goodbye 👋', '© REAL']], {                      
